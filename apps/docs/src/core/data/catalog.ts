...
export const release = { version: packageJson.version, archive: `/downloads/morphui-${packageJson.version}.tgz`, filename: `morphui-${packageJson.version}.tgz` };
export const themes = [
...
export const sharedProps = [
  ...
  ['chrome', 'ReactNode', '—', 'Panel furniture such as the close button. Its own layer over the content, held at its own size and corner for the whole transition.'],
